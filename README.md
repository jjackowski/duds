...
- gcc 12.3.x, 11.3.x, 9.2.x to 9.4.x, 7.3.x
...
- [Boost](http://www.boost.org/) version 1.62 or newer, tested to 1.82
...
- Build host
  - Linux
    - Raspberry Pi OS, Raspbian, Debian, Ubuntu, and similar:
      - Use build configuration setting "BOOSTTAG=" (equals empty string) given to SCons. This changes the expected name of the Boost libraries; these Linux distributions do not use the default names from the Boost build.
