...
- [Boost](http://www.boost.org/) version 1.62 or newer
  ...
  - Raspbian, Debian, and Ubuntu need build configuration setting BOOSTTAG= (equals empty string) given to SCons. This changes the expected name of the Boost libraries; these Linux distributions do not use the default names from the Boost build.
